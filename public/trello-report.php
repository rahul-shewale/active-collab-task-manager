...
<head>
  ...
  <title>Trello Task Report</title>
...
<body class="bg-light">
  <nav class="navbar navbar-dark" style="background:linear-gradient(135deg,#4f46e5,#7c3aed);">
    <div class="container-fluid">
      <span class="navbar-brand fw-bold">Task Dashboard - Trello Report</span>
      <div class="d-flex gap-2">
        <a class="btn btn-light btn-sm" href="/trello-report.php">Report</a>
        ...
        <a class="btn btn-outline-light btn-sm" href="/ac-clients.php">AC Clients</a>
      </div>
    </div>
  </nav>
