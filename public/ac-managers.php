...
<body class="bg-light">
  <nav class="navbar navbar-dark" style="background:linear-gradient(135deg,#4f46e5,#7c3aed);">
    <div class="container-fluid">
      <span class="navbar-brand fw-bold">Task Dashboard - AC Managers</span>
      <div class="d-flex gap-2">
        ...
        <a class="btn btn-light btn-sm" href="/ac-managers.php">AC Managers</a>
